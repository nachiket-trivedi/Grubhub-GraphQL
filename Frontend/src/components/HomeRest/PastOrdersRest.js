...
class PastOrdersRest extends Component {
    constructor(props){
        super(props);
            super(props);
            finalOrder=[];
    ...
    render(){
        ...
        if(allOrders!=undefined)
        {
                    ...
                    console.log('ye dekhoo',order_id, order_status, order_cust)
        ...
        return(
            ...
            <h1 class='h1' style={{textAlign:"center"}}>Your past orders  <span style={{fontSize:40}}>&#127827;</span></h1><br/><br/><br/>
            <table class='table'>
                {finalOrder}
            </table>
            <div class='container'>
...
export default connect(mapStateToProps,mapDispatchToProps)(PastOrdersRest);